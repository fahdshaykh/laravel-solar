              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-floating">
                  <select class="form-select" name="status" id="floatingSelectStatus">
                    <option selected="selected" value="New" @if($lead->status=='New') selected @endif>New</option>
                    <option value="suspended" @if($lead->status=='suspended') selected @endif>suspended</option>
                    <option value="ongoing" @if($lead->status=='ongoing') selected @endif>ongoing</option>
                    <option value="Current" @if($lead->status=='Current') selected @endif>Current</option>
                  </select>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-floating">
                  <select class="form-select" name="source" id="floatingSelectLeadSource">
                    <option selected="selected" value="Advertisement" @if($lead->source=='Advertisement') selected @endif>Advertisement</option>
                    <option value="Advertisement One" @if($lead->source=='Advertisement One') selected @endif>Advertisement One</option>
                    <option value="Advertisement Two" @if($lead->source=='Advertisement Two') selected @endif>Advertisement Two</option>
                    <option value="Consulting" @if($lead->source=='Consulting') selected @endif>Consulting</option>
                  </select>
