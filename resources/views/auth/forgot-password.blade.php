                  ...
                  <div class="col mx-auto">
                    <div class="auth-form-box">
                      <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="">
                        ...
                        <h3 class="text-1000">Forgot your password?</h3>
                        <p class="text-700">Enter your email below and we will send <br class="d-xxl-none" />you a reset link</p>
                      </div>
                     <form class="d-flex align-items-center mb-5" method="POST" action="{{ route('password.email') }}">
				  @csrf
			
                  <input class="form-control flex-1" id="email" type="email" name="email" :value="old('email')" required autofocus placeholder="Email" />
