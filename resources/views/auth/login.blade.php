...
<html lang="en-US" dir="ltr">
    ...
    <head>
        ...
        <!--    Document Title-->
        <!-- ===============================================-->
        <title> Login - {{$webdata->details}}</title>
      ...
      <div class="container-fluid bg-300 dark__bg-1200">
                ...
                <div class="row align-items-center gx-0 gy-7">
                  <div class="col-auto bg-100 dark__bg-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                    ...
                    <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                      <h3 class="mb-3 text-black fs-1">{{$webdata->details}}</h3>
                      <p class="text-700">{{$webdata->details}} Company Portal To Manage All Company Relative Task At One Plateform</p>
                  ...
                  <div class="col mx-auto">
                    <div class="auth-form-box">
                      <div class="text-center mb-7"><a class="d-flex flex-center text-decoration-none mb-4" href="">
                          ...
                          <img src="{{ asset('template/'.$webdata->photo2) }}" alt="phoenix" width="58" />
                          </div>
                        </a>
	    ...
	    <div class="mb-3 text-start">
                ...
                <div class="form-icon-container">
                  <input class="form-control form-icon-input" id="email" type="email" name="email" value="{{old('email')}}" required placeholder="name@example.com" />
			   ...
			   <div class="mb-3 text-start">
                ...
                <div class="form-icon-container">
                  <input class="form-control form-icon-input" id="password" type="password" name="password" required placeholder="Password" />
