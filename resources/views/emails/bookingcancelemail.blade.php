...
<body>
    ...
    <main>
        ...
        <p><strong>Dear {{$booking->speaker->first_name.' '.$booking->speaker->last_name}}</strong></p>
        <p>We are regretfully inform you that booking you make on {{$booking->created_at}} is <strong>cancelled</strong> by our User {{$booking->user->first_name.' '.$booking->user->last_name}}.</p>
