...
<body>
    ...
    <main>
        ...
        <p>We are regretfully inform you that booking you make on {{$booking->created_at}} is <strong>rejected</strong> by our speaker {{$booking->speaker->first_name.' '.$booking->speaker->last_name}}.</p>
