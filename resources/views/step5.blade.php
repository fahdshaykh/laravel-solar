							...
							<div class="elementor-widget-container">
								...
								<div class="gf_browser_chrome gform_wrapper gravity-theme gform-theme--no-framework"
									...
									<form method="post" enctype="multipart/form-data" 
										id="gform_3"
										action="{{route('updateproposalfronthousetype')}}" data-formid="3" style="">
										@csrf
										<div class="gform-body gform_body">
											
											<div id="gform_page_3_3" class="gform_page" data-js="page-field-id-44">
												<div class="gform_page_fields">
													<div id="gform_fields_3_3"
														...
														<div id="field_3_17"
															...
															data-js-reload="field_3_17"><span class="titleBlue">About
																Your Home</span>
															<span class="titleThin">What type of House do you
																have?</span>
														</div>
														<fieldset id="field_3_23"
															class="gfield gfield--type-radio gfield--type-choice gfield--input-type-radio gfield--width-full trigger-next-zzd hide-next-button hide-submit-button has-input-name gfield_contains_required field_sublabel_below gfield--no-description field_description_below hidden_label field_validation_below gfield_visibility_visible"
															data-js-reload="field_3_23">
															<legend class="gfield_label gform-field-label">House
																Type<span class="gfield_required"><span
																		class="gfield_required gfield_required_text">(Required)</span></span>
															</legend>
															<div class="ginput_container ginput_container_radio">
																<div class="gfield_radio" id="input_3_23">
																	<div class="gchoice gchoice_3_23_0">
																		<input type="hidden" value="{{$id}}" name="id" />
                                            <input class="gfield-choice-input" 
                                                name="input_23" type="radio"
                                                value="Apartment" id="choice_3_23_0"
                                                >
																		<label for="choice_3_23_0" id="label_3_23_0"
																			class="gform-field-label gform-field-label--type-inline">
																			<div class="pillBox"><img
																					src="{{ asset('assets_web/img/form-icons_0010_001-apartment.jpg')}}"><span>Apartment</span>
																			</div>
																		</label>
																	</div>
																	<div class="gchoice gchoice_3_23_1">
																		<input class="gfield-choice-input"
																			name="input_23" type="radio" value="Condo" required
																			id="choice_3_23_1"
																			>
																		<label for="choice_3_23_1" id="label_3_23_1"
																			class="gform-field-label gform-field-label--type-inline">
																			<div class="pillBox"><img
																					src="{{ asset('assets_web/img/form-icons_0005_007-duplex.jpg')}}"><span>Condo
																					/ Duplex</span></div>
																		</label>
																	</div>
																	<div class="gchoice gchoice_3_23_2">
																		<input class="gfield-choice-input"
																			name="input_23" type="radio"
																			value="Mobile Home" id="choice_3_23_2"
																			>
																		<label for="choice_3_23_2" id="label_3_23_2"
																			class="gform-field-label gform-field-label--type-inline">
																			<div class="pillBox"><img
																					src="{{ asset('assets_web/img/form-icons_0003_008-mobile-home.jpg')}}"><span>Mobile
																					Home</span></div>
																		</label>
																	</div>
																	<div class="gchoice gchoice_3_23_3">
																		<input class="gfield-choice-input"
																			name="input_23" type="radio" required
																			value="Single Home" id="choice_3_23_3"
																			>
																		<label for="choice_3_23_3" id="label_3_23_3"
																			class="gform-field-label gform-field-label--type-inline">
																			<div class="pillBox"><img
																					src="{{ asset('assets_web/img/form-icons_0009_002-house.jpg')}}"><span>Single
																					Home</span></div>
																		</label>
																	</div>
																</div>
												 ...
												 <div class="gform_page_footer top_label">
													...
													<input type="submit" id="gform_next_button_3_9" class="gform_next_button gform-theme-button button keep_hidden" value="Next">
